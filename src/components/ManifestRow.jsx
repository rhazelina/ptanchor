    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[12px] text-slate line-clamp-1 mt-0.5">{product.ringkas}</p>
        </div>
      </div>
      ...
      {/* Kemasan — hidden on mobile */}
      <div className="hidden md:block px-4">
        <span className="text-[13px] text-ink font-medium">{product.kemasan}</span>
      </div>
