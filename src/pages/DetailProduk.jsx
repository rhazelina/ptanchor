...
export default function DetailProduk({ slug }) {
    ...
    return (
      <section className="bg-paper">
        <div className="mx-auto max-w-[1200px] px-5 lg:px-16 py-20 text-center">
          <h1 className="font-display font-semibold text-[1.75rem] text-ink mb-3">Produk tidak ditemukan</h1>
          <p className="text-slate mb-6">Produk yang anda cari tidak ada dalam katalog kami.</p>
          <Button as="a" href="#/produk">
            <ArrowLeft size={14} />
    ...
    <>
        ...
        <div className="mx-auto max-w-[1200px] px-5 lg:px-16 py-12 grid grid-cols-1 md:grid-cols-[340px_1fr] gap-10 items-start">
          ...
          <div className="rounded-sm border border-limestone-dark overflow-hidden shadow-sm bg-white">
            ...
            <div className="px-4 py-3 border-t border-limestone-dark bg-white">
              <p className="text-[12px] text-slate text-center">
                Kemasan standar: <strong className="text-ink">{product.kemasan}</strong>
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-limestone px-5 py-4 rounded-sm border border-limestone-dark mb-2">
              <h4 className="font-semibold text-[14px] text-ink mb-1.5">Pesan &amp; Minta Penawaran</h4>
              <p className="text-[13px] text-slate mb-4">
                Hubungi tim sales untuk spesifikasi teknis lengkap, harga grosir, dan sampel produk.
              </p>
              <div className="flex flex-wrap gap-3">
                <Button
                  as="a"
                  variant="whatsapp"
                  href={waLink(`Halo PT Anchor Pakan Jaya, saya ingin meminta penawaran untuk ${product.name} (Grade: ${product.grade}, Kemasan: ${product.kemasan}).`)}
                >
      ...
      <section className="border-b border-limestone-dark bg-paper">
        <div className="mx-auto max-w-[1200px] px-5 lg:px-16 py-14">
          <h2 className="font-display font-semibold text-[1.75rem] text-ink mb-6">Spesifikasi teknis produk</h2>
          <div className="bg-white border border-limestone-dark rounded-sm overflow-hidden">
            {product.spesifikasi.map((s, idx) => (
              <div
                key={s.label}
      ...
      {related.length > 0 && (
        <section className="bg-paper">
          <div className="mx-auto max-w-[1200px] px-5 lg:px-16 py-14">
            <h2 className="font-display font-semibold text-[1.75rem] text-ink mb-6">Produk sejenis</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              {related.map((p) => (
                ...
                >
                  ...
                  <p className="text-[13px] text-slate line-clamp-2 mb-3 flex-1">{p.ringkas}</p>
