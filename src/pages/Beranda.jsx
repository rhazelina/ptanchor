...
export default function Beranda() {
  return (
    <>
        ...
        <div className="mx-auto max-w-[1200px] px-5 lg:px-16 pt-12 pb-16 lg:pt-16 lg:pb-20 grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-12 items-center">
          <div>
            ...
            <p className="text-[15px] text-slate max-w-[52ch] mb-8 leading-relaxed">
              Memasok mineral, toxin binder, dan aditif pakan ternak berkualitas tinggi untuk industri feed mill, integrator, distributor, dan peternak skala besar di seluruh Indonesia.
            </p>
          ...
          <div className="border border-limestone-dark rounded-sm overflow-hidden bg-white shadow-xs">
            <div className="relative h-48 overflow-hidden bg-limestone border-b border-limestone-dark">
              ...
              <div className="absolute bottom-3 left-4 right-4 flex items-center justify-between text-white font-mono text-[11px]">
                <span className="uppercase tracking-wider font-medium">GUDANG PUSAT CIKARANG</span>
            ...
            <div className="divide-y divide-limestone-dark font-mono text-[12px]">
              {[
                { label: 'Kapasitas Pasokan', value: '2.500 Ton / Bulan', icon: Truck },
                { label: 'Sertifikasi Mutu', value: 'ISO 9001 · GMP+ · Halal', icon: FileCheck },
                { label: 'Pengalaman Industri', value: '12+ Tahun (Est. 2014)', icon: Clock },
                { label: 'Jangkauan Pengiriman', value: 'Seluruh Indonesia', icon: ShieldCheck },
              ].map((r) => {
        ...
        <div className="mx-auto max-w-[1200px] px-5 lg:px-16 py-16">
          <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <h2 className="font-display font-semibold text-[1.85rem] text-ink">Kategori produk</h2>
            </div>
            <p className="text-[14px] text-slate max-w-[48ch]">
              Lini utama mineral, aditif, dan premix terstandarisasi untuk industri pakan ternak.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-5 flex items-center justify-between text-[12px] text-slate pt-3 border-t border-limestone-dark/80 font-mono">
                    <span className="font-medium text-slate-dark">{count} Varian Produk</span>
      ...
      {/* ── 03. PRODUK UNGGULAN (MANIFEST TABLE) ── */}
      <section className="border-b border-limestone-dark bg-paper">
        <div className="mx-auto max-w-[1200px] px-5 lg:px-16 py-16">
          <div className="flex flex-wrap items-end justify-between gap-4 mb-8">
            <div>
              ...
              <h2 className="font-display font-semibold text-[1.85rem] text-ink">Produk unggulan</h2>
            </div>

            <Button as="a" variant="secondary" href="#/produk" className="group">
          ...
          <div className="bg-white border border-limestone-dark rounded-sm overflow-hidden shadow-xs">
            ...
            <div className="hidden md:grid md:grid-cols-[2fr_1fr_1fr_auto] gap-x-4 px-5 py-3 bg-[#F4F4EE] text-[11px] text-anchor-navy font-mono font-semibold uppercase tracking-wider border-b border-limestone-dark">
              ...
              <span className="text-right">SPESIFIKASI</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 mb-8">
              {[
                ...
                { t: 'Dokumentasi COA (Certificate of Analysis)', d: 'Certificate of Analysis per batch untuk transparansi kandungan teknis.' },
                { t: 'Dukungan Teknis & Formulasi Pakan', d: 'Tim konsultan pendamping untuk aplikasi pakan ternak di lapangan.' },
              ].map((x) => (
            ...
            <Button as="a" href="#/tentang" variant="tertiary" className="group">
              <span>Selengkapnya tentang kontrol kualitas</span>
          ...
          <div className="rounded-sm border border-limestone-dark overflow-hidden bg-white shadow-xs">
            ...
            <div className="p-4 border-t border-limestone-dark bg-paper">
              <span className="text-[11px] font-mono font-semibold text-grain-gold-dark uppercase tracking-widest block mb-1">
                FASILITAS KONTROL MUTU CIKARANG
              </span>
              <p className="text-[13px] text-slate leading-relaxed">
                Laboratorium uji mutu mineral, aditif, &amp; premix pakan bersertifikat ISO 9001:2015.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-paper">
        <div className="mx-auto max-w-[1200px] px-5 lg:px-16 py-16">
          <div className="mb-8">
            ...
            <h2 className="font-display font-semibold text-[1.85rem] text-ink mb-2">Aplikasi per sektor ternak</h2>
